...
- upload creation now allows multiple concurrent jobs on the same dataset as long as each job can claim distinct free products; launches are rejected only when no candidate products remain free for the requested selection
